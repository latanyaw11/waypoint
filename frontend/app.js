...
function renderPlaces() {
  ...
  if (!places.length) {
    list.innerHTML = '<div class="empty">No places yet. Search above, or add a Celebrity Pick.</div>';
    return;
  }
  // Build HTML using safe string concatenation — no nested template literals
  var html = '';
